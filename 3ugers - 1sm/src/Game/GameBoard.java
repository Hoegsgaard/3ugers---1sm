...
public class GameBoard {
	...
	public void createBoard() {
		...
		createStreet(9, "Allégade", Color.pink, 2400, housePrice[0], rentAllégade);
		/* Fængsel (På besøg) */fields[10] = new GUI_Jail();
		fields[10].setSubText("På besøg");
		createStreet(11, "Frederiksberg Allé", Color.green, 2800, housePrice[0], rentFrederiksbergalle);
		/* Cola */ fields[12] = new GUI_Brewery();
		// Mangler SUB
		createStreet(13, "Büllowsvej", Color.green, 2800, housePrice[1], rentBülowsvej);
		...
		createStreet(23, "Østerbrogade", Color.red, 4400, housePrice[2], rentØsterbrogade);
		createStreet(24, "Grønningen", Color.red, 4800, housePrice[2], rentGrønningen);
